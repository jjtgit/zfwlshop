...
public class ShoppingCarAdapter extends BaseExpandableListAdapter {
    ...
    private final LinearLayout btnOrder;
    ...
    public ShoppingCarAdapter(Context context, LinearLayout llSelectAll, ImageView ivSelectAll, LinearLayout btnOrder, TextView btnDelete, LinearLayout rlTotalPrice, TextView tvTotalPrice, TextView numbers) {
    ...
    public View getGroupView(final int groupPosition, final boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(context, R.layout.shop_store_adapter, null);
        ...
        if (isSelect_shop) {
            groupViewHolder.ivSelect.setImageResource(R.mipmap.more_select);
        } else {
            groupViewHolder.ivSelect.setImageResource(R.mipmap.not_select);
        }
        ...
        if (isSelectAll) {
            ivSelectAll.setBackgroundResource(R.mipmap.more_select);
        } else {
            ivSelectAll.setBackgroundResource(R.mipmap.not_select);
        }
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            for (int y = 0; y < goods.size(); y++) {
                ...
                if (isSelect) {
                    ...
                    numbers.setText("("+numm+")");
            }
            }
        }
        EventBus.getDefault().post(numm+"");
        //去结算的点击事件
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        //商品是否被选中
        if (isSelect) {
            childViewHolder.ivSelect.setImageResource(R.mipmap.more_select);
        } else {
            childViewHolder.ivSelect.setImageResource(R.mipmap.not_select);
        }
        //商品选择框的点击事件
        ...
        number = childViewHolder.tvEditBuyNumber.getText().toString();
        if (number.equals("1")){
            childViewHolder.imgSubtractor.setImageResource(R.mipmap.subtract_background);
        }else {
            childViewHolder.imgSubtractor.setImageResource(R.mipmap.subtract_background_black);
        }
        //加号的点击事件
    ...
    static class ChildViewHolder {
        ...
        LinearLayout ivEditSubtract;
        @BindView(R.id.tv_edit_buy_number)
        EditText tvEditBuyNumber;
        @BindView(R.id.iv_edit_add)
        LinearLayout ivEditAdd;
        @BindView(R.id.img_subtractor)
        ImageView imgSubtractor;
        @BindView(R.id.view)
        View view;
        @BindView(R.id.views)
        View views;
