...
/**
 * Created by 修梦 on 2019/10/30.
 * Describe:五星评论工具类
 */
public class RatingBarUtils extends LinearLayout {
    /**
     * 是否可点击
     */
     ...
     * @param attrs
     */
    public RatingBarUtils(Context context, AttributeSet attrs) {
        super(context, attrs);
        setOrientation(LinearLayout.HORIZONTAL);
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.RatingBarUtils);
        starImageSize = mTypedArray.getDimension(R.styleable.RatingBarUtils_starImageSize, 20);
        starPadding = mTypedArray.getDimension(R.styleable.RatingBarUtils_starPadding, 10);
        starStep = mTypedArray.getFloat(R.styleable.RatingBarUtils_starStep, 1.0f);
        stepSize = StepSize.fromStep(mTypedArray.getInt(R.styleable.RatingBarUtils_stepSize, 1));
        starCount = mTypedArray.getInteger(R.styleable.RatingBarUtils_starCount, 5);
        starEmptyDrawable = mTypedArray.getDrawable(R.styleable.RatingBarUtils_starEmpty);
        starFillDrawable = mTypedArray.getDrawable(R.styleable.RatingBarUtils_starFill);
        starHalfDrawable = mTypedArray.getDrawable(R.styleable.RatingBarUtils_starHalf);
        mClickable = mTypedArray.getBoolean(R.styleable.RatingBarUtils_clickable, true);
        mTypedArray.recycle();
